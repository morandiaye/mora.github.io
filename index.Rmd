...
Spatial data science is becoming day by day crucial in many field like agriculture , remote sensing,transportation so one thereby mastering spatial aspect can bring many advantages in the livelihoods of many people in the world.These resources below contribute to  spread all knowledge that people can need to learn spatial data science.It's good to admit these resource listed are no exhaustive and if someone see other which can  improve quality of these resources feel free to bring proposal.
Lot of languages let's to facilitate working in spatial data science.Many of them are developed below.
...
This package let's make 3D potting for traditional plot generating by using ggplot and plot that represent the earth properties
